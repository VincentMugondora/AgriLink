    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 leading-relaxed">Sign up as a farmer, trader, or buyer. Complete KYC verification to join our trusted community.</p>
        </div>
        <div className="text-center">
          ...
          <p className="text-gray-600 leading-relaxed">Farmers list their produce with photos and details. Buyers browse and find exactly what they need.</p>
        </div>
        <div className="text-center">
          ...
          <p className="text-gray-600 leading-relaxed">Place orders, make secure payments, and arrange delivery. Track your orders from farm to doorstep.</p>
        </div>
      </div>
    </div>
  </section>
